...
from FANCI.exceptions import UnsuitableFeatureOrderException
from FANCI.mypublicsuffixlist import myPublicSuffixes
...
VOWELS = set('aeiou')
PARTS_MAX_CONSIDERED = 20

PUBLIC_SUF = myPublicSuffixes()
...
def extract_myfeatures(d:str,features):
    return extract_features(d,(_length,  _vowel_ratio, _digit_ratio, _contains_ipv4_addr, _contains_digits, \
                         _contains_one_char_subdomains, _contains_wwwdot, _subdomain_lengths_mean, \
...
def _shannon_entropy():
    ...
    if __unigram is ():
        raise UnsuitableFeatureOrderException('The feature _n_grams has to be calculated before.')
    # print("shann")
    # print(stats.entropy(__unigram, base=2))
...
if __name__=="__main__":
    # print(__dot_split_suffix_free)
    # print(VALID_PUB_SUFFIXES)
    print(extract_features("baiducdn.com", [_n_grams,_shannon_entropy]))
    print(extract_features("tytre9iu.ru", [_n_grams,_shannon_entropy]))
